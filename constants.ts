...
export const REALM_PROGRESSION: RealmProgression[] = [
  // Cảnh giới 0: Luyện Khí
  {
    ...
    levels: [
      ...
      { qiRequired: 25000, levelName: "Tầng 13 (Đỉnh Phong)", bonuses: { maxHp: [180, 250], maxMana: [90, 120], attackPower: [10, 15], defensePower: [8, 12], canCot: 3, thanPhap: 3, thanThuc: 3, ngoTinh: 3, maxThoNguyen: [10, 20] } },
    ]
  },
  // Cảnh giới 1: Trúc Cơ
  {
