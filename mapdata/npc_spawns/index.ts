...
import { THIEN_NAM_NPC_SPAWNS } from './thien_nam';
import { BAC_VUC_NPC_SPAWNS } from './bac_vuc';
import { DAI_HOANG_NPC_SPAWNS } from './dai_hoang';
import { DONG_HAI_NPC_SPAWNS } from './dong_hai';
