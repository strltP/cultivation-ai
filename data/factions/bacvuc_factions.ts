...
export const BACVUC_FACTIONS: Faction[] = [
    {
        ...
        roles: [
          { 
            ...
            power: 90, 
            realmDistribution: [
              { realmIndex: 4, level: 1, weight: 7 }, // Nguyen Anh Trung Ki
              { realmIndex: 4, level: 2, weight: 3 }, // Nguyen Anh Hau Ki
            ],
          ...
          { 
            ...
            power: 70, 
            realmDistribution: [
              { realmIndex: 3, level: 2, weight: 8 }, // Kim Dan Hau Ki
              { realmIndex: 3, level: 3, weight: 2 }, // Kim Dan Dinh Phong
            ],
    ...
    },
    {
        ...
        roles: [
          { 
            ...
            titleChance: { base: 0.65, perRealm: 0.06 },
    ...
    },
    {
        ...
        roles: [
          { 
            ...
            titleChance: { base: 0.55, perRealm: 0.05 },
          ...
          { 
            ...
            titleChance: { base: 0.02, perRealm: 0.04 },
