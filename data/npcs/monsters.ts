...
export const ALL_MONSTERS: MonsterDefinition[] = [
    {
        ...
        baseStats: {
            maxHp: 80, attackPower: 10, defensePower: 5, speed: 12, critRate: 0.05, critDamage: 1.5, armorPenetration: 0,
    ...
    },
    {
        ...
        baseStats: {
            maxHp: 60, attackPower: 12, defensePower: 8, speed: 10, critRate: 0.08, critDamage: 1.6, armorPenetration: 0.02,
            kimDamageBonus: 0, mocDamageBonus: 0, thuyDamageBonus: 0, hoaDamageBonus: 0, thoDamageBonus: 0,
            phongDamageBonus: 0, loiDamageBonus: 0, bangDamageBonus: 0, quangDamageBonus: 0, amDamageBonus: 0,
        },
        lootTable: [
